    ...
    <div class="dt-header__container">
      ...
      <div class="dt-brand">
        ...
        <a class="dt-brand__logo-link" href="index-2.html">
          <img class="dt-brand__logo-img d-none d-lg-inline-block" src="assets/default/assets/images/logo.png" alt="Wieldy">
          <img class="dt-brand__logo-symbol d-lg-none" src="assets/default/assets/images/logo-symbol.png" alt="Wieldy">
        </a>
      </span>
        <!-- /brand logo -->
                ...
                <div class="dropdown-menu-body ps-custom-scrollbar">
                  ...
                  <div class="h-auto">
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/stella-johnson.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/jeson-born.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/selena.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/alex-dolgove.jpg" alt="User">
                      <!-- avatar -->
                ...
                <div class="dropdown-menu-body ps-custom-scrollbar">
                  ...
                  <div class="h-auto">
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/mathew.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/steve-smith.jpg" alt="User">
                      <!-- avatar -->
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <!-- Avatar -->
                      <img class="dt-avatar mr-3" src="assets/default/assets/images/user-avatar/domnic-brown.jpg" alt="User">
                      <!-- avatar -->
          ...
          <ul class="dt-nav d-lg-none">
            <li class="dt-nav__item dropdown">
              ...
              <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                ...
                <img class="dt-avatar size-40" src="assets/default/assets/images/user-avatar/domnic-harris.jpg" alt="Domnic Harris">
              </a>
              <!-- /dropdown link -->
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <div class="dt-avatar-wrapper flex-nowrap p-6 mt--5 bg-gradient-purple text-white rounded-top">
                  <img class="dt-avatar" src="assets/default/assets/images/user-avatar/domnic-harris.jpg" alt="Domnic Harris">
